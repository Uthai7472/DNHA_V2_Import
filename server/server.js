    ...
    try {
        ...
        for (let i = 0; i < seatLeakFiles.length; i++) {
                ...
                for (const data of seatLeakJsonArray) {
                    ...
                    const modifiedDateTime = moment(dateTime, 'D/M/YYYY HH:mm').format('YYYY-MM-DD HH:mm:ss');
            ...
            for (const data of bodyJsonArray) {
                ...
                await new Promise((resolve, reject) => {
                    connection.query(`
                        ...
                        END
                    `, [lotNo, modifiedDateTime, lotNo, bodyLot], (err, results) => {
                        if (err) {
                ...
                await new Promise((resolve, reject) => {
                    connection.query(`
                        ...
                        BEGIN
                            SELECT 'Duplicate LotNO found, record not inserted' AS Message;
                        END
                    `, [lotNo, modifiedDateTime, lotNo, needleLot], (err, results) => {
                        if (err) {
